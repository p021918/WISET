...
var config = {
  ...
  uaa: {
    clientId: 'client-joo',
    serverUrl: 'https://be068f80-f477-40d6-9d34-8772600e2d76.predix-uaa.run.aws-usw02-pr.ice.predix.io',
    defaultClientRoute: '/about',
    base64ClientCredential: 'Y2xpZW50LWpvbzoxMjM0NQ=='
  },
  /**
  ...
  proxy: {
    '/api/view-service': {
      ...
      instanceId: 'b84cea34-8bad-4eba-a2ea-c75c0deec15e',
      pathRewrite: { '^/api/view-service': '/v1'}
    },
    '/api/timeseries-service/datapoints': {
      url: 'https://time-series-store-predix.run.aws-usw02-pr.ice.predix.io',
      instanceId: 'dfcc34d9-50f2-49e2-ab3f-f54aed461cef',
      pathRewrite: {
          '^/api/timeseries-service/datapoints': '/v1/datapoints'
      }
    }
  }
};
